  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-12 px-4 sm:px-6 relative">
      <div className="text-center mb-10">
        <h2 className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-primary-600 to-primary-900 tracking-tight mb-3 inline-block">
