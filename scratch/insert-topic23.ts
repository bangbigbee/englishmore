...
const hardLesson2 = [
  ...
  { question: "It ________ a rainy day, we stayed indoors.", optionA: "is", optionB: "was", optionC: "being", optionD: "been", correctOption: "C", explanation: "Cấu trúc độc lập (Absolute Phrase): N1 + V-ing/P2, N2 + V2. Khi 2 mệnh đề khác chủ ngữ, ta giữ nguyên chủ ngữ N1 và biến động từ thành V-ing. (It being = Because it was).", translation: "Vì là một ngày mưa, chúng tôi đã ở trong nhà.", tips: "It being = Because it was" },
