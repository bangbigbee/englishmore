...
export default async function ReadingBank({ filter = 'mistakes', partFilter }: { filter?: string, partFilter?: string }) {
	...
	const requiredTier = masterConfig.grammar?.readingBookmarkAccessTier || 'PRO'
	...
	if (items.length === 0) {
		return (
			<div className="space-y-4">
                <PartFilterBank type="reading" activePart={partFilter} />
                <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center shadow-sm">
