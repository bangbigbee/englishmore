                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:max-w-2xl">
                    ...
                    <div className="relative w-full sm:flex-1">
                        ...
                        <input
                            ...
                            className="block w-full pl-9 pr-3 py-2 sm:py-2.5 border border-slate-200 rounded-xl text-[13px] font-medium leading-5 bg-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#14532d]/20 focus:border-[#14532d] sm:text-sm transition-all shadow-sm"
                        />
                    </div>
                    ...
                    <div className="relative z-30 w-full sm:w-[220px] shrink-0">
                        <div className="relative">
                            <button 
                                ...
                                className="w-full flex items-center justify-between gap-2 px-3.5 py-2 sm:py-2.5 bg-white border border-slate-200 rounded-xl shadow-sm hover:border-[#14532d]/30 hover:shadow-md transition-all group active:scale-[0.99]"
                            >
                                <div className="flex items-center gap-2 truncate">
                                    <span className="w-5 h-5 rounded-[6px] bg-green-50 text-[#14532d] flex items-center justify-center shrink-0">
                                ...
                                {isTopicOpen && (
                                    ...
                                    >
                                        <button 
                                            ...
                                            className={`w-full flex items-center gap-3 px-3 py-2 text-left transition-colors border-l-4 ${currentTopic === 'all' ? 'bg-green-50 border-[#ea980c] text-[#14532d]' : 'border-transparent text-slate-600 hover:bg-slate-50'}`}
                                        >
                                        ...
                                        {topics.map(t => (
                                            <button 
                                                ...
                                                className={`w-full flex items-center gap-3 px-3 py-2 text-left transition-colors border-l-4 ${currentTopic === t ? 'bg-green-50 border-[#ea980c] text-[#14532d]' : 'border-transparent text-slate-600 hover:bg-slate-50'}`}
                                            >
