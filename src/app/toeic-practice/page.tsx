	...
	return (
		...
		>
			...
			{type === 'grammar' ? (
				...
				<div className="relative z-10 mt-auto pt-6 flex justify-end overflow-visible">
					<div className="perspective-[1000px] w-[116px] h-[38px] shrink-0">
						<div className="relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
							<div className="absolute inset-0 w-full h-full rounded-lg bg-white shadow-[0_15px_40px_-5px_rgba(0,0,0,0.2)] border border-slate-50 flex items-center justify-center [backface-visibility:hidden]">
								<svg className="w-5 h-5 text-green-600 ml-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M9 5l7 7-7 7" />
								</svg>
							</div>
							<div className="absolute inset-0 w-full h-full rounded-lg bg-[#f59e0b] shadow-[0_10px_20px_-5px_rgba(0,0,0,0.2)] flex items-center justify-center gap-1.5 [backface-visibility:hidden] [transform:rotateY(180deg)] overflow-hidden">
