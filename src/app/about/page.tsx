...
export default async function AboutPage() {
	...
	return (
		<div className="min-h-screen bg-slate-50 relative overflow-hidden flex flex-col z-0">
			...
			<div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-8 pb-20 relative z-10">
					...
					<div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start relative z-10">
						...
						<div className="flex flex-col items-center gap-6 shrink-0 z-10 w-full md:w-auto">
							...
							<div className="relative group mx-auto">
								...
								<div className="absolute -bottom-4 right-0 md:right-auto md:-right-4 py-1.5 px-4 rounded-full bg-[#14532d] border-2 border-white shadow-lg text-white font-black text-sm z-30 flex items-center gap-1.5 cursor-default truncate">
									<svg className="w-4 h-4 text-[#ea980c] shrink-0" viewBox="0 0 24 24" fill="currentColor">
							...
							{/* Contact Buttons under Avatar */}
							<div className="flex gap-2.5 justify-center flex-wrap">
								<a 
									href={fbLink} 
									target="_blank" 
									rel="noopener noreferrer" 
									className="flex items-center gap-1.5 px-3 py-1.5 bg-[#eff6ff] text-[#1d4ed8] hover:bg-[#2563eb] hover:text-white rounded-[10px] font-bold transition-all shadow-sm group border border-blue-100 hover:border-[#2563eb] text-[11px]"
								>
								...
								<a 
									...
									target="_blank" 
									rel="noopener noreferrer" 
									className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 text-slate-800 hover:bg-black hover:text-white rounded-[10px] font-bold transition-all shadow-sm group border border-slate-200 hover:border-black text-[11px]"
								>
									<svg className="w-3.5 h-3.5 transition-transform group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
