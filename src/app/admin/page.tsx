...
const COURSE_DESCRIPTION_TEMPLATE = [
  ...
  '',
  '6. Học phí',
  '* Toàn bộ khóa học: 3.800.000 VND (đang trong giai đoạn ưu đãi học phí)',
  '* Sau phiên học thứ 3, nếu cảm thấy phù hợp với khóa học: chuyển học phí theo hướng dẫn.',
  '',
  '7. Tôi chưa từng học tiếng Anh bài bản, có theo kịp không?',
  ...
  '',
  '8. Sau khi hoàn thành khóa học này, tôi có thể đạt được những kỹ năng gì?',
  ...
  '',
  '9. Tôi có thể đăng ký và bắt đầu học như thế nào?',
  ...
  '',
  '10. Tôi cần chuẩn bị gì khi tham gia khóa học?',
