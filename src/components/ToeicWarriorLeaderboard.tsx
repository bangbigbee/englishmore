                ...
                >
                  ...
                  <td className="py-4 px-4">
                    ...
                    >
                      ...
                      <div className="text-primary-900 font-normal text-[13px] flex items-center gap-1.5">
                        {w.isAnonymousLeaderboard ? w.name.split(' ')[0] + ' ***' : w.name}
                        {session?.user?.id === w.id && (
                          <div className={`flex items-center justify-center p-1 rounded-full transition-colors ${w.isAnonymousLeaderboard ? 'bg-slate-100 text-slate-400' : 'bg-primary-50 text-primary-500'}`}>
