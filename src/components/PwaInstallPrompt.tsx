            ...
            <div className="bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] border border-[#581c87]/10 p-4 sm:p-5 flex flex-col sm:flex-row gap-4 items-center max-w-md mx-auto">
                ...
                <div className="flex items-center gap-4 w-full sm:w-auto">
                    ...
                    <div className="flex-1 text-left">
                        ...
                        <p className="text-[12px] text-slate-500 mt-0.5">Cài đặt ứng dụng vào màn hình chính để truy cập nhanh hơn.</p>
                    </div>
                </div>
                ...
                <div className="flex w-full sm:w-auto gap-2 sm:gap-3 shrink-0">
                    ...
                    <button 
                        ...
                        className="flex-1 sm:flex-none px-5 py-2.5 rounded-xl font-bold text-[13px] text-white bg-[#581c87] hover:bg-[#4c1d95] active:bg-[#3b0764] shadow-md transition-colors"
                    >
                        Cài đặt ngay
                    </button>
                </div>
